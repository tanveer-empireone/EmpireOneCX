...
<main style="background-color: #000;">
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "name": "Healthcare BPO", "url": "https://empireonecx.com/healthcare-bpo" },
    ...
    <section class="controlbtns samesectionpadding pb-[10px] md:pb-[40px] pt-[60px] md:pt-[80px] relative overflow-hidden bg-cover bg-center">
        <div class="container mx-auto">
            <div class="linebtns flex flex-nowrap md:flex-wrap justify-start md:justify-center items-center gap-4 
                ...
                <a href="#retail" class="line-btn snap-center whitespace-nowrap active flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v1.webp" class="w-[24px] h-[24px] object-contain" alt="Retail icon"> <span>Retails</span>
                </a>

                <a href="#automotive" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v2.webp" class="w-[24px] h-[24px] object-contain" alt="Automotive icon"> <span>Automotive</span>
                </a>

                <a href="#travel" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v3.webp" class="w-[24px] h-[24px] object-contain" alt="Travel icon"> <span>Travel</span>
                </a>

                <a href="#technical" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v4.webp" class="w-[24px] h-[24px] object-contain" alt="Telco icon"> <span>Telco</span>
                </a>

                <a href="#insurance" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v5.webp" class="w-[24px] h-[24px] object-contain" alt="Insurance icon"> <span>Insurance</span>
                </a>

                <a href="#healthcare" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v6.webp" class="w-[24px] h-[24px] object-contain" alt="Healthcare icon"> <span>Healthcare</span>
                </a>

                <a href="#energy" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v7.webp" class="w-[24px] h-[24px] object-contain" alt="Energy icon"> <span>Energy</span>
                </a>

                <a href="#utility" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v8.webp" class="w-[24px] h-[24px] object-contain" alt="Utility icon"> <span>Utility</span>
                </a>

                <a href="#technology" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v9.webp" class="w-[24px] h-[24px] object-contain" alt="Technology icon"> <span>Technology</span>
                </a>

                <a href="#government" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v10.webp" class="w-[24px] h-[24px] object-contain" alt="Government icon"> <span>Government</span>
                </a>

                <a href="#legal" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v11.webp" class="w-[24px] h-[24px] object-contain" alt="Legal icon"> <span>Legal</span>
                </a>

                <a href="#financeservices" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v12.webp" class="w-[24px] h-[24px] object-contain" alt="Finance icon"> <span>Finance Services</span>
                </a>

                <a href="#ecommerce" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v13.webp" class="w-[24px] h-[24px] object-contain" alt="eCommerce icon"> <span>eCommerce</span>
                </a>

                <a href="#realestate" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v14.webp" class="w-[24px] h-[24px] object-contain" alt="Real Estate icon"> <span>Real Estate</span>
                </a>

                <a href="#gaming" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v15.webp" class="w-[24px] h-[24px] object-contain" alt="Gaming icon"> <span>Gaming</span>
                </a>

                <a href="#homeservices" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v16.webp" class="w-[24px] h-[24px] object-contain" alt="Home Services icon"> <span>Home Services</span>
                </a>

                <a href="#homewarranty" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    <img src="assets/images/v17.webp" class="w-[24px] h-[24px] object-contain" alt="Home Warranty icon"> <span>Home Warranty</span>
                </a>

                <a href="#transportationlogistics" class="line-btn snap-center whitespace-nowrap flex flex-row items-center justify-center gap-2 px-6 md:px-8 py-4 rounded-[8px] text-white text-[16px] bg-[#29292B] hover:bg-[linear-gradient(90deg,#7A76FF_0%,#CB46FA_50.14%,#FE881C_100%)]">
                    ...
                    <div class="indussections border-b border-[#605468] pt-[40px] pb-[60px] scroll-animate" id="insurance">
                        ...
                        <div class="indusweoffer relative w-[1094px] mx-auto -mt-[109px] z-[99]">
                            ...
                            <div class="mytextoffer relative p-8">
                                ...
                                <div class="mt-6">
                                    <a href="/insurance-bpo" class="text-sm font-medium underline text-[#CB46FA] hover:text-[#7A76FF] transition-colors">Explore Insurance BPO Services &rarr;</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="indussections pt-[40px] pb-[80px] scroll-animate" id="healthcare">
                        ...
                        <div class="indusweoffer relative w-[1094px] mx-auto -mt-[109px] z-[99]">
                            ...
                            <div class="mytextoffer relative p-8">
                                ...
                                <div class="mt-6">
                                    <a href="/healthcare-bpo" class="text-sm font-medium underline text-[#CB46FA] hover:text-[#7A76FF] transition-colors">Explore Healthcare BPO Services &rarr;</a>
                                </div>
                            </div>
                        </div>
                    </div>
