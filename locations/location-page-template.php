            ...
            <div class="location-detail-grid">
                <div>
                    <nav class="breadcrumb-nav mb-6 mt-10 lg:mt-14" aria-label="Breadcrumb">
                        <a href="/locations">Global Footprint</a>
                        <span class="sep">/</span>
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <a href="/locations" class="inline-flex items-center justify-center text-white py-4 px-8 text-sm sm:text-base border border-white/30 hover:border-white/60 transition-all duration-300" style="border-radius: 8px !important; background: rgba(255,255,255,0.08);">
