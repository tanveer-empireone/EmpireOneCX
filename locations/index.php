...
$metaDescription = "Explore EmpireOneCX location pages for Canada, the United States, the United Kingdom, Australia, and the UAE. Learn how our global CX and BPO delivery model supports growing brands.";
$metaKeywords = "EmpireOneCX global footprint, BPO global footprint, CX outsourcing Canada, CX outsourcing United States, CX outsourcing United Kingdom, CX outsourcing Australia, BPO UAE";
...
<main style="background-color: #ffffff;">
    ...
    <?= json_encode([
        ...
        "description" => "Priority EmpireOneCX global market pages for CX and BPO outsourcing services.",
        "itemListElement" => array_map(function ($location, $index) {
            return [
                "@type" => "ListItem",
                "position" => $index + 1,
                "name" => $location["name"],
                "url" => "https://empireonecx.com/locations/" . $location["slug"],
            ];
                            ...
                            <div class="indusweoffer relative w-[1094px] mx-auto -mt-[109px] z-[99]">
                                ...
                                <div class="mytextoffer relative p-8">
                                    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                                        ...
                                        <a href="/locations/<?= htmlspecialchars($location["slug"], ENT_QUOTES, "UTF-8") ?>" class="inline-flex items-center justify-center shrink-0 px-6 py-3 rounded-[8px] text-white text-[14px] leading-[20px] font-medium bg-[#7A76FF]">
