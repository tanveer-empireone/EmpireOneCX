...
<main class="relative">
        ...
        <div class="container mx-auto w-full relative z-10">
            <div class="hero-main-heading-work">
                ...
                <div class="hero-subpara font-normal hero-css-reveal delay-3 text-gray-300 text-sm sm:text-base lg:text-lg sm:max-w-3xl mx-auto px-4 mb-8 sm:mb-6">
                    <p class="mb-4">
                        EmpireOneCX delivers secure, scalable, AI-assisted CX and BPO services. Powered by AI, Perfected by Humans.
                    </p>
                </div>
                ...
                <div class="hero-css-reveal delay-4">
                    <button onclick="window.location.href='contact'" class="herobtns bg-gradient-to-r from-[#7A76FF] via-[#CB46FA] to-[#FE881C] text-white py-4 px-8 text-sm sm:text-base hover:transition-all duration-300 shadow-lg hover:shadow-purple-400/20" style="border-radius: 8px !important;">
                         Build Your CX Team Today & Go Live in 72 Hours
                    </button>
                </div>
            </div>
        </div>
                ...
                <div class="mybuiltlogo flex flex-wrap items-center justify-center sm:gap-5">
                    <div class="relative group">
                        ...
                        <div class="mainboxshover absolute bottom-full left-1/2 -translate-x-1/2 mb-3
                            ...
                            Verified controls for security, availability, and data protection.
                        </div>
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="mainboxshover absolute bottom-full left-1/2 -translate-x-1/2 mb-3
                            ...
                            Secure credit card data processing.
                        </div>
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="mainboxshover absolute bottom-full left-1/2 -translate-x-1/2 mb-3
                            ...
                            Protected handling of healthcare data.
                        </div>
                    </div>
                    ...
                    <div class="relative group cursor-pointer">
                        ...
                        <div class="mainboxshover absolute bottom-full left-1/2 -translate-x-1/2 mb-3
                            ...
                            EU personal data protection standards.
                        </div>
                    </div>
                ...
                <div class="space-y-6 empire-slide-left" id="about-left">
                    ...
                    <div class="keyrespons pb-[25px]">
                        <div class="topheadkeys pb-[22px]">
                            <h3 class="text-[24px] leading-[40px] text-slate-900 font-semibold">What sets EmpireOneCX apart</h3>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div class="flex items-center">
                                ...
                                <p class="text-[16px] keychangefont text-[#3C3B47]">Dedicated offshore teams</p>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="text-[16px] keychangefont text-[#3C3B47]">Secure & compliant delivery</p>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="text-[16px] keychangefont text-[#3C3B47]">AI-assisted workflows</p>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="text-[16px] keychangefont text-[#3C3B47]">Long-term partnership mindset</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mytexx grid grid-cols-1 md:grid-cols-5 gap-x-6 gap-y-10 md:gap-x-8 md:gap-y-6 text-center mt-8">
                        ...
                        <div class="flex flex-col items-center space-y-4">
							...
							<p class="counterpara text-[14px] sm:text-[15px] md:text-[16px] leading-[22px] sm:leading-[24px] tracking-[-0.02em] text-gray-700 text-center">
								Years of advancing digital operations with AI
							</p>
						</div>
                        ...
                        <div class="flex flex-col items-center space-y-4">
							...
							<p class="counterpara text-[14px] sm:text-[15px] md:text-[16px] leading-[22px] sm:leading-[24px] tracking-[-0.02em] text-gray-700 text-center">
								Enterprise deployments in core functions
							</p>
						</div>
                        ...
                        <div class="flex flex-col items-center space-y-4">
							...
							<p class="counterpara text-[14px] sm:text-[15px] md:text-[16px] leading-[22px] sm:leading-[24px] tracking-[-0.02em] text-gray-700 text-center">
								Client Satisfaction from trusted enterprise partners
							</p>
						</div>
                        ...
                        <div class="flex flex-col items-center space-y-4">
							...
							<p class="counterpara text-[14px] sm:text-[15px] md:text-[16px] leading-[22px] sm:leading-[24px] tracking-[-0.02em] text-gray-700 text-center">
								AI Monitoring for quality and compliance
							</p>
						</div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center max-w-8xl mx-auto mb-20">
                <div class="maintopheservice">
                    ...
                    <h3 class="solution-heading text-[48px] leading-[40px] tracking-[-0.03em] text-center text-white mb-[20px] pt-[22px]">
                        Our AI-Assisted <span style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">CX & outsourcing</span> Solutions
                    </h3>
                    <p class="solution-para text-[16px] leading-[24px] tracking-[1px] text-center text-white max-w-[630px] mx-auto">
                        EmpireOneCX provides end-to-end outsourcing services designed to support every stage of your business operations.
                    </p>
                </div>
            </div>
            ...
            <div class="flex gap-[22px] overflow-x-auto snap-x snap-mandatory max-[767px]:flex min-[768px]:grid md:grid-cols-2 lg:grid-cols-3 min-[768px]:overflow-visible [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
                <div class="mainpics group relative overflow-hidden transition-all duration-500 h-[525px] snap-center max-[767px]:min-w-[85%] fade-zoom-reveal">
                    ...
                    <div class="solution-cardset relative z-20 p-8 flex flex-col h-full">
                        ...
                        <h3 class="about-subtext relative flex items-center gap-2 py-3 overflow-hidden">
                            <span class="relative z-10 flex items-center gap-2">
                                <span class="block w-[24px] h-[4px] rounded" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);"></span>
                                <span class="makespx text-white text-[20px] leading-[28px] tracking-[-0.03em]">Scalable CX & BPO Teams</span>
                            </span>
                        </h3>
                ...
                <div class="mainpics group relative overflow-hidden transition-all duration-500 h-[525px] snap-center max-[767px]:min-w-[85%] fade-zoom-reveal">
                    ...
                    <div class="solution-cardset relative z-20 p-8 flex flex-col h-full">
                        ...
                        <h3 class="about-subtext relative flex items-center gap-2 py-3 overflow-hidden">
                            <span class="relative z-10 flex items-center gap-2">
                                <span class="block w-[24px] h-[4px] rounded" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);"></span>
                                <span class="makespx text-white text-[20px] leading-[28px] tracking-[-0.03em]">Offshore Process Outsourcing</span>
                            </span>
                        </h3>
                        <div class="hover-reveal-content">
                            <p class="pt-[12px] text-[16px] leading-[24px] text-white/90 max-w-[340px] mb-6">
                ...
                <div class="mainpics group relative overflow-hidden transition-all duration-500 h-[525px] snap-center max-[767px]:min-w-[85%] fade-zoom-reveal">
                    ...
                    <div class="solution-cardset relative z-20 p-8 flex flex-col h-full">
                        ...
                        <h3 class="about-subtext relative flex items-center gap-2 py-3 overflow-hidden">
                            <span class="relative z-10 flex items-center gap-2">
                                <span class="block w-[24px] h-[4px] rounded" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);"></span>
                                <span class="makespx text-white text-[20px] leading-[28px] tracking-[-0.03em]">Offshore Accounting Teams</span>
                            </span>
                        </h3>
                        <div class="hover-reveal-content">
                            <p class="pt-[12px] text-[16px] leading-[24px] text-white/90 max-w-[340px] mb-6">
                ...
                <div class="mainpics group relative overflow-hidden transition-all duration-500 h-[525px] snap-center max-[767px]:min-w-[85%] fade-zoom-reveal">
                    ...
                    <div class="solution-cardset relative z-20 p-8 flex flex-col h-full">
                        ...
                        <h3 class="about-subtext relative flex items-center gap-2 py-3 overflow-hidden">
                            <span class="relative z-10 flex items-center gap-2">
                                <span class="block w-[24px] h-[4px] rounded" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);"></span>
                                <span class="makespx text-white text-[20px] leading-[28px] tracking-[-0.03em]">Call Center QA Outsourcing</span>
                            </span>
                        </h3>
                        <div class="hover-reveal-content">
                            <p class="pt-[12px] text-[16px] leading-[24px] text-white/90 max-w-[340px] mb-6">
                ...
                <div class="mainpics group relative overflow-hidden transition-all duration-500 h-[525px] snap-center max-[767px]:min-w-[85%] fade-zoom-reveal">
                    ...
                    <div class="solution-cardset relative z-20 p-8 flex flex-col h-full">
                        ...
                        <h3 class="about-subtext relative flex items-center gap-2 py-3 overflow-hidden">
                            <span class="relative z-10 flex items-center gap-2">
                                <span class="block w-[24px] h-[4px] rounded" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);"></span>
                                <span class="makespx text-white text-[20px] leading-[28px] tracking-[-0.03em]">Global Hiring Solutions</span>
                            </span>
                        </h3>
                        <div class="hover-reveal-content">
                            <p class="pt-[12px] text-[16px] leading-[24px] text-white/90 max-w-[340px] mb-6">
                ...
                <div class="mainpics group relative overflow-hidden transition-all duration-500 h-[525px] snap-center max-[767px]:min-w-[85%] fade-zoom-reveal">
                    ...
                    <div class="solution-cardset relative z-20 p-8 flex flex-col h-full">
                        <h2 class="font-semibold text-[24px] md:text-[32px] leading-[40px] text-white mb-1 transition-transform duration-500 group-hover:-translate-y-2">
                            AI-Assisted Customer Experience Solutions
                        </h2>
                        <h3 class="about-subtext relative flex items-center gap-2 py-3 overflow-hidden">
                            <span class="relative z-10 flex items-center gap-2">
                                <span class="block w-[24px] h-[4px] rounded" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);"></span>
                                <span class="makespx text-white text-[20px] leading-[28px] tracking-[-0.03em]">Intelligent Process Automation</span>
                            </span>
                        </h3>
                        <div class="hover-reveal-content">
                            <p class="pt-[12px] text-[16px] leading-[24px] text-white/90 max-w-[340px] mb-6">
    ...
    <section class="globe-capability-work">
        <div class="globe-capability-work-header">
            <h2>Global Scalable Customer Experience Delivery Capability</h2>
            <p>
                This global footprint enables 24/7 operations, multilingual support, and cultural alignment.
            </p>
        </div>
            ...
            <div class="changework grid gap-5 lg:grid-cols-2 gap-16 mb-10" style="align-items: center;">
                <div class="reveal-left">
                    ...
                    <h2 class="about-heading text-[32px] md:text-[48px] leading-[40px] md:leading-[56px] tracking-[-0.03em] mb-8 text-black" style="margin-top: 4px;">
                        Why Businesses Choose EmpireOneCX
                    </h2>
                </div>
                <div class="reveal-right">
                    <p class="abformate text-[#3C3B47] text-[16px] leading-relaxed max-w-xl mb-10" style="max-width: 630px;">
                        At EmpireOneCX, we offer a unique blend of experience, innovation, and quality that sets us apart from other CX industry players. Here are some compelling reasons why you should choose us
                    </p>
                </div>
            </div>
                        ...
                        <div class="mainformattext bg-white rounded-[calc(1rem-1px)] p-6 flex flex-row md:flex-col items-start gap-4 md:gap-[20px] h-full">
                            ...
                            <div class="boxesfont sm:ml-4 md:ml-0">
                                <h3 class="text-[18px] leading-[28px] text-[#000000] mb-1 md:mb-9" style="font-weight: 600;">
                                    Dedicated & Scalable Teams
                                </h3>
                                <img src="assets/images/linebot.webp" loading="lazy" alt="Dedicated & Scalable Teams" decoding="async" class="mb-[15px]">
                                <p class="text-[16px] text-slate-700 leading-[24px] leading-relaxed">
                                    Get fully dedicated, non-shared teams built around your business goals. Scale up or down quickly with flexible engagement models designed to match your growth.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-[14px] shadow-md p-[2px] h-[100%]" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);box-shadow: 0px 6px 16px 0px rgba(77, 77, 92, 0.14);">
                        <div class="mainformattext bg-white rounded-[calc(1rem-1px)] p-6 flex flex-row md:flex-col items-start gap-4 md:gap-[20px] h-full">
                            ...
                            <div class="boxesfont sm:ml-4 md:ml-0">
                                ...
                                <img src="assets/images/linebot.webp" loading="lazy" alt="AI-Driven Operational Excellence" decoding="async" class="mb-[15px]">
                                <p class="text-[16px] text-slate-700 leading-[24px] leading-relaxed">
                ...
                <div class="reveal-right">
                    <div class="rounded-[14px] shadow-md p-[2px] h-[100%]" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);box-shadow: 0px 6px 16px 0px rgba(77, 77, 92, 0.14);">
                        <div class="mainformattext bg-white rounded-[calc(1rem-1px)] p-6 flex flex-row md:flex-col items-start gap-4 md:gap-[20px] h-full">
                            ...
                            <div class="boxesfont sm:ml-4 md:ml-0">
                                <h3 class="text-[18px] leading-[28px] text-[#000000] mb-1 md:mb-9" style="font-weight: 600;">
                                    Secure, Compliant & Transparent Operations
                                </h3>
                                <img src="assets/images/linebot.webp" loading="lazy" alt="Secure, Compliant & Transparent Operations" decoding="async" class="mb-[15px]">
                                <p class="text-[16px] text-slate-700 leading-[24px] leading-relaxed">
                                    Your data is protected through secure, compliant operations and backed by transparent reporting that gives you full visibility into performance and results
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="reveal-right">
                    <div class="rounded-[14px] shadow-md p-[2px] h-[100%]" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);box-shadow: 0px 6px 16px 0px rgba(77, 77, 92, 0.14);">
                        <div class="mainformattext bg-white rounded-[calc(1rem-1px)] p-6 flex flex-row md:flex-col items-start gap-4 md:gap-[20px] h-full">
                            ...
                            <div class="boxesfont sm:ml-4 md:ml-0">
                                <h3 class="text-[18px] leading-[28px] text-[#000000] mb-1 md:mb-9" style="font-weight: 600;">
                                    Proven Delivery & Performance Results
                                </h3>
                                <img src="assets/images/linebot.webp" loading="lazy" alt="Proven Delivery & Performance Results" decoding="async" class="mb-[15px]">
                                <p class="text-[16px] text-slate-700 leading-[24px] leading-relaxed">
                                    We deliver measurable outcomes through proven processes, consistent execution, and a results-first mindset that drives real business impact.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="maincooporate reveal-left">
                    ...
                    <p class="businesstext text-[16px] leading-[24px] tracking-[-0.02em] text-[rgba(60,59,71,1)] mb-10 max-w-[505px] ">
                        We believe that business success is measured not only by growth but also by impact. EmpireOneCX is deeply committed to creating positive change through our people and communities.
                    </p>
                    ...
                    <div class="flex flex-col items-start gap-4">
                        ...
                        <p class="coptext [font-family:'helvetica',Arial,sans-serif] font-medium text-[24px] leading-[32px] tracking-[0em] bg-gradient-to-r from-[#7A76FF] via-[#CB46FA] to-[#FE881C] bg-clip-text text-transparent">
                            We believe sustainable growth comes 
                            <br class="nobreak"> from creating positive impact.
                        </p>
                    </div>
                </div>
                <div class="socialcards grid grid-cols-1 md:grid-cols-2 gap-6 relative">
                    <div class="relative z-10 space-y-6">
                            ...
                            <div class="csr-card-work bg-white rounded-[calc(1rem-1px)] py-8 pl-[20px] pr-[20px] flex flex-row md:flex-col items-start md:items-center text-left md:text-center gap-4 md:gap-0 h-full">
                                ...
                                <div class="maintextss flex-1">
                                    ...
                                    <p class="text-[16px] text-slate-600 leading-[24px]">
                                        Providing opportunities and support for local causes
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="p-[2px] rounded-2xl bg-gradient-to-br from-[#7A76FF] via-[#CB46FA] to-[#FF8A00] shadow-sm reveal-right">
                            <div class="csr-card-work bg-white rounded-[calc(1rem-1px)] py-8 pl-[20px] pr-[20px] flex flex-row md:flex-col items-start md:items-center text-left md:text-center gap-4 md:gap-0 h-full">
                                <div class="flex-shrink-0 w-[64px] h-[64px] sm:w-16 sm:h-16 md:w-16 md:h-16 flex items-center justify-center md:mb-4">
                                    <img src="assets/images/homeWell-being.webp" loading="lazy" alt="Employee Well-being" decoding="async" class="w-full h-full object-contain">
                                </div>
                                <div class="maintextss flex-1">
                                    <h3 class="text-[18px] leading-[28px] mb-2" style="font-weight: 600;">
                                        Employee Well-being
                                    ...
                                    <p class="text-[16px] text-slate-600 leading-[24px]">
                                        Promoting mental health, balance, and professional growth
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="csrlast-cards relative z-10 space-y-6 md:mt-12">
                        <div class="p-[2px] rounded-2xl bg-gradient-to-br from-[#7A76FF] via-[#CB46FA] to-[#FF8A00] shadow-sm reveal-right">
                            <div class="csr-card-work bg-white rounded-[calc(1rem-1px)] py-8 pl-[20px] pr-[20px] flex flex-row md:flex-col items-start md:items-center text-left md:text-center gap-4 md:gap-0 h-full">
                                <div class="flex-shrink-0 w-[64px] h-[64px] sm:w-16 sm:h-16 md:w-16 md:h-16 flex items-center justify-center md:mb-4">
                                    <img src="assets/images/homeResponsibility.webp" alt="Environmental Responsibility" loading="lazy" decoding="async" class="w-full h-full object-contain">
                                </div>
                                <div class="maintextss flex-1">
                                    <h3 class="text-[18px] leading-[28px] mb-2" style="font-weight: 600;">
                                    ...
                                    <p class="text-[16px] text-slate-600 leading-[24px]">
                                        Adopting sustainable practices within our operations
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="p-[2px] rounded-2xl bg-gradient-to-br from-[#7A76FF] via-[#CB46FA] to-[#FF8A00] shadow-sm reveal-right">
                            <div class="csr-card-work bg-white rounded-[calc(1rem-1px)] py-8 pl-[20px] pr-[20px] flex flex-row md:flex-col items-start md:items-center text-left md:text-center gap-4 md:gap-0 h-full">
                                ...
                                <div class="maintextss flex-1">
                                    ...
                                    <p class="text-[16px] text-slate-600 leading-[24px]">
                                        Supporting programs that uplift future generations
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="active faq-item group border-none bg-white shadow-sm transition-all duration-300 hover:shadow-md [&.active]:bg-gradient-to-r [&.active]:from-[#7A76FF] [&.active]:via-[#CB46FA] [&.active]:to-[#FE881C]">
        <button onclick="toggleFaq(this)" class="flex items-center justify-between w-full p-5 sm:p-6 text-left focus:outline-none">
            ...
            <h3 class="text-[18px] md:text-[22px] font-semibold text-slate-800 group-[.active]:text-white pr-8">What services does EmpireOneCX offer?</h3>
        ...
        <div class="faq-content">
            <div class="px-5 pb-5 sm:px-6 sm:pb-6 text-slate-600 group-[.active]:text-white/90 leading-relaxed border-t border-slate-50 group-[.active]:border-white/20 pt-4">
                ...
                <p>EmpireOneCX provides a comprehensive suite of outsourcing solutions including:</p>
                ...
                <ul class="mt-3 space-y-2 list-disc list-inside group-[.active]:text-white">
                    ...
                    <li>Finance & Accounting BPO</li>
                    <li>QA Services</li>
                    <li>Recruitment & Workforce Support</li>
                    <li>AI-Assisted BPO Solutions</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="faq-item group bg-white border-top border-slate-200 shadow-sm transition-all duration-300 hover:shadow-md [&.active]:bg-gradient-to-r [&.active]:from-[#7A76FF] [&.active]:via-[#CB46FA] [&.active]:to-[#FE881C]">
                    <button onclick="toggleFaq(this)" class="flex items-center justify-between w-full p-5 sm:p-6 text-left focus:outline-none">
    <h3 class="text-[18px] md:text-[22px] font-semibold text-slate-800 group-[.active]:text-white pr-8">Do you provide dedicated offshore teams?</h3>
    <span class="faq-icon flex-shrink-0 ">
        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
        </svg>
                    ...
                    <div class="faq-content">
                        <div class="px-5 pb-5 sm:px-6 sm:pb-6 text-slate-600 group-[.active]:text-white/90 leading-relaxed border-t border-slate-50 group-[.active]:border-white/20 pt-4">
                            Yes. We specialize in building <span class="font-medium group-[.active]:text-white">dedicated, full-time offshore teams</span> that act as a seamless extension of your company, aligned exclusively to your business goals and culture.
                        </div>
                    </div>
                </div>
                ...
                <div class="faq-item group bg-white border-top border-slate-200 shadow-sm transition-all duration-300 hover:shadow-md [&.active]:bg-gradient-to-r [&.active]:from-[#7A76FF] [&.active]:via-[#CB46FA] [&.active]:to-[#FE881C]">
                    <button onclick="toggleFaq(this)" class="flex items-center justify-between w-full p-5 sm:p-6 text-left focus:outline-none">
                        <h3 class="text-[18px] md:text-[22px] font-semibold text-slate-800 group-[.active]:text-white pr-8">Are your operations secure and compliant?</h3>
                        <span class="faq-icon flex-shrink-0 ">
                            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                    ...
                    <div class="faq-content">
                        <div class="px-5 pb-5 sm:px-6 sm:pb-6 text-slate-600 group-[.active]:text-white/90 leading-relaxed border-t border-slate-50 group-[.active]:border-white/20 pt-4">
                            Absolutely. Data security is our priority. We maintain compliance with:
                ...
                <div class="faq-item group bg-white border-top border-slate-200 shadow-sm transition-all duration-300 hover:shadow-md [&.active]:bg-gradient-to-r [&.active]:from-[#7A76FF] [&.active]:via-[#CB46FA] [&.active]:to-[#FE881C]">
                    <button onclick="toggleFaq(this)" class="flex items-center justify-between w-full p-5 sm:p-6 text-left focus:outline-none">
                        <h3 class="text-[18px] md:text-[22px] font-semibold text-slate-800 group-[.active]:text-white pr-8">How fast can we launch a team?</h3>
                        <span class="faq-icon flex-shrink-0 ">
                            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                ...
                <div class="faq-item group bg-white border-top border-slate-200 shadow-sm transition-all duration-300 hover:shadow-md [&.active]:bg-gradient-to-r [&.active]:from-[#7A76FF] [&.active]:via-[#CB46FA] [&.active]:to-[#FE881C]">
                    <button onclick="toggleFaq(this)" class="flex items-center justify-between w-full p-5 sm:p-6 text-left focus:outline-none">
                        <h3 class="text-[18px] md:text-[22px] font-semibold text-slate-800 group-[.active]:text-white pr-8">Can you scale teams up or down?</h3>
                        <span class="faq-icon flex-shrink-0 ">
                            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                    ...
                    <div class="faq-content">
                        <div class="px-5 pb-5 sm:px-6 sm:pb-6 text-slate-600 group-[.active]:text-white leading-relaxed border-t border-slate-50 group-[.active]:border-black/20 pt-4">
                            Yes. Our engagement models are designed for <span class="font-medium group-[.active]:text-white">maximum flexibility</span>. Whether you're experiencing seasonal surges or rapid growth, we can scale your team size to match your operational requirements effortlessly.
                        </div>
                    </div>
                </div>
            </div>
					...
					<div class="ctamain text-center">
						<div class="cta-left-sidework pt-[60px] pb-[60px]">
							<h2 class="solution-heading future-heading text-[32px] md:text-[48px] leading-[38px] md:leading-[56px] tracking-[-0.03em] text-black mb-[15px] md:mb-[20px]">
								Reinvent Customer Experience <br class="nobreak"> with <span class="solutionsitalic-font text-[32px] md:text-[48px] leading-[38px] md:leading-[56px] tracking-[-0.03em]">EmpireOneCX</span>
							</h2>
