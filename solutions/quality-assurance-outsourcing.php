...
@media (max-width: 767px) {
  ...
  .qa-page .cx-hero-section .container {
    max-width: 100% !important;
    padding-left: 0 !important;
    padding-right: 0 !important;
  }

  .qa-page .cx-hero-grid {
    display: grid !important;
    grid-template-columns: minmax(0, 1fr) !important;
    gap: 26px !important;
  }

  .qa-page .breadcrumb-nav {
  ...
  .qa-page .breadcrumb-nav a,
  .qa-page .breadcrumb-nav span {
    font-size: 13px !important;
    line-height: 20px !important;
  }

  .qa-page .breadcrumb-nav .sep {
    margin: 0 !important;
  }

  .qa-page .cx-hero-section .herosubtitle {
  ...
  .qa-page .cx-hero-section .solutions-hero-heading {
  ...
  .qa-page .cx-hero-section .subpara,
  .qa-page .cx-hero-section .text-center > p:not(.herosubtitle) {
  ...
  .qa-page .cx-hero-section .delay-4 {
    display: flex !important;
    width: 100% !important;
  ...
  .qa-page .cx-hero-section .delay-4 a,
  .qa-page .cx-hero-section .delay-4 button {
    display: flex !important;
  ...
  .qa-page .cx-hero-form {
    display: none !important;
  }

  .qa-page .samesectionpadding {
    padding-top: 58px !important;
    padding-bottom: 58px !important;
  }

  .qa-page .solution-heading,
  .qa-page .solution-heading span {
    max-width: 100% !important;
  ...
  .qa-page .cx-feature-card {
    padding: 28px 20px !important;
  }

  .qa-page .cx-comparison-table {
