...
@media (max-width: 767px) {
  .backoffice-page .cx-hero-section {
    height: auto !important;
  ...
  .backoffice-page .cx-hero-section .container {
    max-width: 100% !important;
    padding-left: 0 !important;
    padding-right: 0 !important;
  }

  .backoffice-page .cx-hero-grid {
    display: grid !important;
    grid-template-columns: minmax(0, 1fr) !important;
    gap: 26px !important;
  }

  .backoffice-page .breadcrumb-nav {
  ...
  .backoffice-page .breadcrumb-nav a,
  .backoffice-page .breadcrumb-nav span {
    font-size: 13px !important;
    line-height: 20px !important;
  }

  .backoffice-page .breadcrumb-nav .sep {
    margin: 0 !important;
  }

  .backoffice-page .cx-hero-section .herosubtitle {
  ...
  .backoffice-page .cx-hero-section .solutions-hero-heading {
  ...
  .backoffice-page .cx-hero-section .subpara,
  .backoffice-page .cx-hero-section .cx-hero-grid > div:first-child > p:not(.herosubtitle) {
  ...
  .backoffice-page .cx-hero-section .delay-4 {
    display: flex !important;
    width: 100% !important;
  ...
  .backoffice-page .cx-hero-section .delay-4 a,
  .backoffice-page .cx-hero-section .delay-4 button {
    display: flex !important;
  ...
  .backoffice-page .cx-hero-form {
    display: none !important;
  }

  .backoffice-page .samesectionpadding {
    padding-top: 58px !important;
    padding-bottom: 58px !important;
  }

  .backoffice-page .solution-heading,
  .backoffice-page .solution-heading span {
    max-width: 100% !important;
  ...
  .backoffice-page .cx-feature-card {
    padding: 28px 20px !important;
  }

  .backoffice-page .cx-comparison-table {
