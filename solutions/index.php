...
@media (max-width: 767px) {
    .solutions-page .hero-section.mainherowork {
        height: auto;
        min-height: 640px;
    ...
    .solutions-page .hero-section.mainherowork .container {
        max-width: 100% !important;
        padding-left: 0 !important;
        padding-right: 0 !important;
    }

    .solutions-page .solutions-bg-videowork {
        inset: 0;
        width: 100%;
        height: 100%;
        object-fit: cover;
    ...
    .solutions-page .hero-section .absolute.bg-black\/50 {
        inset: 0;
        width: auto !important;
        height: auto !important;
    }

    .solutions-page .solutions-hero-heading {
    ...
    .solutions-page .hero-section.mainherowork .herosubtitle {
        display: block;
        width: 100%;
    ...
    .solutions-page .samesectionpadding {
        padding-top: 56px !important;
        padding-bottom: 56px !important;
    }

    .solutions-page .solgap {
        gap: 16px !important;
        margin-bottom: 22px !important;
    }

    .solutions-page .solgap h2 > span {
        align-items: flex-start;
    }

    .solutions-page .solgap h2 .spanfont:last-child {
        font-size: 17px !important;
        line-height: 23px !important;
    }

    .solutions-page .solution-heading,
    .solutions-page .solution-heading span {
        max-width: none !important;
        font-size: 28px !important;
        line-height: 34px !important;
    }

    .solutions-page .company-culture-abformate-solutions-neww {
        font-size: 15px !important;
        line-height: 23px !important;
    }

    .solutions-page .solution-side-img1,
    .solutions-page .solution-side-img2 {
        display: none;
    }

    .solutions-page .lasting-impression-soltuionsimg > div {
        height: auto !important;
        min-height: 0;
    }

    .solutions-page .deskstopdisplay {
        display: none !important;
    }

    .solutions-page .nomobiledisplay {
    ...
    .solutions-page .solheightimg img {
        height: 240px !important;
        object-fit: cover;
    }

    .solutions-page .mainsolthings {
    ...
    .solutions-page .leftsidesoldes {
        width: 100% !important;
        padding-top: 24px !important;
        padding-right: 0 !important;
    }

    .solutions-page .managespacesolution {
        gap: 14px !important;
        margin-bottom: 4px !important;
    }

    .solutions-page .managespacesolution > div {
        align-items: flex-start;
    }

    .solutions-page .managespacesolution p {
        font-size: 15px !important;
        line-height: 22px !important;
    }

    .solutions-page .rightsidesoldes {
        position: static !important;
        width: 100%;
        margin: 0 0 6px;
    }

    .solutions-page .noheightemp {
        width: 100%;
    }
    ...
    .solutions-page .boxesfont h3 {
        font-size: 21px !important;
        line-height: 27px !important;
        margin-bottom: 12px !important;
    }

    .solutions-page .boxesfont > img {
        max-width: 100%;
        margin-bottom: 14px !important;
    }

    .solutions-page .linesli li {
        display: flex;
        align-items: flex-start;
        gap: 10px;
        font-size: 14px !important;
    ...
    .solutions-page .linesli li img {
        flex: 0 0 auto;
        margin-top: 4px;
    }

    .solutions-page .empgaps {
        gap: 14px !important;
    }

    .solutions-page .mytextemp {
        width: auto !important;
    ...
    .solutions-page .empsolbtn {
        flex-direction: column;
        align-items: stretch !important;
        gap: 16px;
    }

    .solutions-page .empsolbtn p {
        width: 100% !important;
    ...
    .solutions-page .empsolbtn a {
        width: 100%;
        text-align: center;
    }

    .solutions-page .future-customer-section {
        padding-top: 56px !important;
        padding-bottom: 56px !important;
    }

    .solutions-page .future-innerwork {
        padding: 34px 18px !important;
    }

    .solutions-page .cta-left-sidework {
        padding-top: 12px !important;
        padding-bottom: 12px !important;
    }

    .solutions-page .future-heading,
    .solutions-page .future-heading span {
        font-size: 28px !important;
        line-height: 34px !important;
    }

    .solutions-page .future-customer-para {
        font-size: 15px !important;
        line-height: 23px !important;
    }
}
...
<main class="solutions-page relative">
    ...
    <section id="customersupport" class="solutions-lastingimpression-section samesectionpadding py-24 pt-[80px] relative overflow-hidden bg-cover bg-center" aria-label="Customer Support Outsourcing">
        <div class="container mx-auto px-4">
            ...
            <div class="lasting-impression-soltuionsimg relative">
                <div class="overflow-hidden rounded-[16px] w-full h-[490px] lg:h-[520px] xl:h-[580px]">
                    <img src="../assets/images/spage1.webp" alt="..." class="fade-zoom-reveal w-full h-full object-cover object-center deskstopdisplay"/>
                    <img src="../assets/images/mobi-so1.webp" alt="..." class="nomobiledisplay"/>
                </div>
            </div>
                ...
                <div class="mainsolthings flex items-left justify-between">
                    ...
                    <div class="rightsidesoldes relative right-[54px] top-[-42px]">
                        <div class="noheightemp rounded-[14px] shadow-md p-[2px]" style="background: linear-gradient(90deg, #7A76FF 0%, #CB46FA 50.14%, #FE881C 100%);box-shadow: 0px 6px 16px 0px rgba(77, 77, 92, 0.14);">
                            <div class="bosx bg-white rounded-[calc(1rem-1px)]
                                            p-6
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="lasting-impression-soltuionsimg relative">
                <div class="solheightimg overflow-hidden rounded-[16px] w-full h-[490px] lg:h-[520px] xl:h-[580px]">
                    <img src="../assets/images/spage2.webp" alt="..." class="fade-zoom-reveal w-full h-full object-cover object-center"/>
                </div>
            </div>
            <div class="solutions-wahtweoffer">
                <div class="mainsolthings flex items-left justify-between">
    ...
    <section id="finance" class="callopportunity-section samesectionpadding py-24 pt-[80px] relative overflow-hidden bg-cover bg-center" aria-label="Finance and Accounting Outsourcing">
        <div class="container mx-auto px-4">
            ...
            <div class="lasting-impression-soltuionsimg relative">
                <div class="solheightimg overflow-hidden rounded-[16px] w-full h-[490px] lg:h-[520px] xl:h-[580px]">
                    <img src="../assets/images/spage3.webp" alt="..." class="fade-zoom-reveal w-full h-full object-cover object-center"/>
                </div>
            </div>
            <div class="solutions-wahtweoffer">
                <div class="mainsolthings flex items-left justify-between">
    ...
    <section id="qualityassurance" class="Precision-solutions-section samesectionpadding bg-[rgba(0,0,0,1)] py-24" aria-label="Quality Assurance Services">
        <div class="container mx-auto px-4">
            ...
            <div class="lasting-impression-soltuionsimg relative">
                <div class="overflow-hidden rounded-[16px] w-full h-[490px] lg:h-[520px] xl:h-[580px]">
                    <img src="../assets/images/spage4.webp" alt="..." class="fade-zoom-reveal w-full h-full object-cover object-center deskstopdisplay"/>
                    <img src="../assets/images/mobi-so4.webp" alt="..." class="nomobiledisplay"/>
                </div>
            </div>
            <div class="solutions-wahtweoffer">
                <div class="mainsolthings flex items-left justify-between">
    ...
    <section id="recruitment" class="communication-solutions-section samesectionpadding py-24 pt-[80px] relative overflow-hidden bg-cover bg-center" aria-label="Recruitment Outsourcing Solutions">
        <div class="container mx-auto px-4">
            ...
            <div class="lasting-impression-soltuionsimg relative">
                <div class="overflow-hidden rounded-[16px] w-full h-[490px] lg:h-[520px] xl:h-[580px]">
                    <img src="../assets/images/spage5.webp" alt="..." class="fade-zoom-reveal w-full h-full object-cover object-center deskstopdisplay"/>
                    <img src="../assets/images/mobi-so5.webp" alt="..." class="nomobiledisplay"/>
                </div>
            </div>
            <div class="solutions-wahtweoffer">
                <div class="mainsolthings flex items-left justify-between">
    ...
    <section id="aienablebpo" class="solutionssresults-section samesectionpadding bg-[rgba(0,0,0,1)] py-24" aria-label="AI Business Process Automation">
        <div class="container mx-auto px-4">
            <div class="solgap grid gap-5 lg:grid-cols-2 gap-16 mb-5" style="align-items: center;">
                <div class="reveal-left">
                    <h2 class="relative flex items-center gap-2 text-sm py-3 overflow-hidden m-0"> 
            ...
            <div class="lasting-impression-soltuionsimg relative">
                <div class="overflow-hidden rounded-[16px] w-full h-[490px] lg:h-[520px] xl:h-[580px]">
                    <img src="../assets/images/spage6.webp" alt="..." class="fade-zoom-reveal w-full h-full object-cover object-center deskstopdisplay"/>
                    <img src="../assets/images/mobi-so6.webp" alt="..." class="nomobiledisplay"/>
                </div>
            </div>
            <div class="solutions-wahtweoffer">
                <div class="mainsolthings flex items-left justify-between">
